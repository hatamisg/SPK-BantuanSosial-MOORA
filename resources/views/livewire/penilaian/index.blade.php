                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center justify-end gap-4">
                                            <a href="{{ route('penilaian.edit', $alt->id) }}"
                                                class="uppercase font-medium text-xs text-gray-700">Nilai</a>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            @empty
                                ...
                                <tr>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                                        colspan="{{ $kriterias->count() + 4 }}">Belum ada data alternatif untuk dinilai.
                                    </td>
                                </tr>
                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    @php
                                        ...
                                        foreach ($kriterias as $k) {
                                            $ks = $alt->kriteria->find($k->id);
                                            $nilai[] = $ks ? $ks->pivot->nilai : 0;
                                            $sum += pow($ks ? $ks->pivot->nilai : 0, 2);
                                        }
                                        
                                        $c = sqrt($sum);
                                        
                                        // Normalisasi setiap nilai pada baris matriks
                                        foreach ($nilai as &$n) {
                                            $n /= $c;
                                        }
                                        unset($n);
                            ...
                            @empty
                                ...
                                <tr>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm"
                                        colspan="{{ $kriterias->count() + 4 }}">Belum ada data alternatif untuk
                                        dinilai.
                                    </td>
                                </tr>
                            @endforelse
